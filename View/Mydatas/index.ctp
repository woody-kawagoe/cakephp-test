<div class="mydatas index">
	...
	<tr>
		...
		<td><?php echo h($mydata['Mydata']['title']); ?>&nbsp;</td>
		<td><?php echo h($mydata['Mydata']['created']); ?>&nbsp;</td>
		<td><?php echo h($mydata['Mydata']['modified']); ?>&nbsp;</td>
		<td><?php echo h($mydata['Mydata']['genre']); ?>&nbsp;</td>
		<td><?php echo h($mydata['Mydata']['tag']); ?>&nbsp;</td>
		<td><?php echo h($mydata['Mydata']['body']); ?>&nbsp;</td>
		<td class="actions">
